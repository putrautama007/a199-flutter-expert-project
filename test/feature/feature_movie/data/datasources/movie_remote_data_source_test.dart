...
void main() {
  ...
  group('get Popular Movies', () {
    final tMovieList = MovieResponse.fromJson(
            json.decode(readJson('core/dummy_data/popular.json')))
        .movieList;
    ...
    test('should return movie detail when the response code is 200', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$baseUrl/movie/$tId?$apiKey')))
          .thenAnswer((_) async => http.Response(
              readJson('core/dummy_data/movie_detail.json'), 200));
  ...
  group('search movies', () {
    final tSearchResult = MovieResponse.fromJson(json
            .decode(readJson('core/dummy_data/search_spiderman_movie.json')))
        .movieList;
