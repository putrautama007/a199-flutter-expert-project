...
void init() {
  ...
  locator.registerFactory(
    () => TvShowDetailNotifier(
      getDetailTvShowsUseCase: locator(),
      getRecommendationTvShowsUseCase: locator(),
  ...
  locator.registerFactory(
    () => TvShowWatchListNotifier(
      getWatchListTvShowsUseCase: locator(),
    ),
  );
  ...
  locator.registerLazySingleton<SearchTvShowsUseCase>(
